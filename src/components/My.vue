<template>
  <section>
    <div class="wrapper">
      <div class="title">
        <div class="cross"></div>
        <div class="hot">My video</div>
        <div class="total">4 videos uploaded</div>
      </div>
      <!-- <div class="content">
        <div class="item">
      ...
      <ul class="content">
        <template v-if="0">
          <li class="item">
            ...
            <span class="introduce">Wonderful playback</span>
          </li>
          <li class="item">
            <div class="img-wrapper">
              <img src="../static/picture3.png" />
            ...
            <span class="introduce">Overseas import</span>
          </li>
          <li class="item">
            <div class="img-wrapper">
              <img src="../static/picture2.png" />
            ...
            <span class="introduce">Wei daxun and Liu yuyu </span>
          </li>
          <li class="item">
            <div class="img-wrapper">
              <img src="../static/picture4.png" />
            ...
            <span class="introduce">OST coming: Thank you all </span>
          </li>
        </template>
        <li v-else class="item1">
           <img src="../static/notFind.png" alt="" class="notlogo">
        </li>
      </ul>
    </div>
  </section>
...
.cross {
  width: 5px;
  height: 16px;
  background-image: linear-gradient(to bottom, rgb(12, 119, 190), #fff);
  position: absolute;
  top: 8px;
  border-radius: 10px;
}
